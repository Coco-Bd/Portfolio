...
const translations = {
  fr: {
    title: "Mes Projets",
    subtitle: "Une sélection de mes projets scolaires et personnels les plus intéressants.",
    all: "Tous",
  ...
  en: {
    title: "My Projects",
    subtitle: "A selection of my most interesting school and personal projects.",
    all: "All",
...
const projects = [
  {
    ...
    description: "Déploiement d'une infrastructure complète sur AWS avec Terraform",
  ...
  },
  {
    ...
    description: "Configuration complète d'un réseau d'entreprise avec VLANs et sécurité",
    titleEn: "Simulated Enterprise Network",
    descriptionEn: "Complete enterprise network configuration with VLANs and security",
    type: "school",
  ...
  },
  {
    ...
    description: "Architecture haute disponibilité avec load balancer et clustering",
    titleEn: "High Availability Web Server",
    descriptionEn: "High availability architecture with load balancer and clustering",
    type: "school",
...
export default function Projects() {
  ...
  const [activeFilter, setActiveFilter] = useState<"all" | "school" | "personal">("all")
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {filteredProjects.length > 0 ? (
              ...
              >
                <div className="relative overflow-hidden rounded-t-lg">
                  ...
                  <div className="absolute top-4 left-4">
                    ...
                    >
                      {project.type === "school" ? t.schoolBadge : t.personalBadge}
                    </Badge>
                  </div>
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-semibold text-white mb-4">{t.noResults}</h3>
